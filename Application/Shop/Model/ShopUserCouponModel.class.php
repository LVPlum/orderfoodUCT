...
class ShopUserCouponModel extends Model{
	//用户收货地址
	...
	*/
	public function get_user_coupon_list($option)
	{
		...
		foreach($ret['list'] as &$item){
			$this->func_get_user_coupon($item);
		}
		//header("Content-type:text/html;charset=utf-8");dump($item['info']);exit;
